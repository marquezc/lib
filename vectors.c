...
struct vec
addvec(struct vec vecA, struct vec vecB)
{
    vecA.x += vecB.x;
    vecA.y += vecB.y;
    vecA.z += vecB.z;
...
struct vec
crossvec(struct vec vecA, struct vec vecB)
{
    struct vec temp;
...
int
dotvec(struct vec vecA, struct vec vecB)
{
